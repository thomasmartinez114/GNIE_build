  ...
  <div class="container">
    <div class="row justify-content-center text-center">
      <div class="col-10 py-5">
        ...
        <p class="lead">Bootstrap is an open-source front-end library with HTML and CSS based designs. This website is
          built with HTML5, CSS3 and Bootstrap 4.</p><a class="btn btn-purple btn-lg"
          href="https://w3newbie.com/courses/" target="_blank">W3NEWBIE COURSES</a>
      </div>
    </div>
  </div>
  <!--- BOOTSTRAP UDEMY COURSE -->
  ...
  <div class="container py-3">
    <div class="row justify-content-center py-5">
      <div class="col-lg-6">
        ...
        <p>Resize the browser window to see the effect. Responsive web design has become more important as the amount of
          mobile traffic now accounts for more than half of total internet traffic.</p><a class="btn btn-purple btn-lg"
          href="https://w3newbie.com/courses/">W3NEWBIE COURSES</a>
      </div>
